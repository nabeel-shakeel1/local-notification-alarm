...
class NotificationController {
  ...
  static Future<void> scheduleNewNotification({required int seconds}) async {
    bool isAllowed = await AwesomeNotifications().isNotificationAllowed();
    if (!isAllowed) isAllowed = await displayNotificationRationale();
    if (!isAllowed) return;
    ...
    await AwesomeNotifications()
      ...
      content: NotificationContent(
          ...
          // customSound: '',
          // customSound: 'assets/custom/sound/30Countdown.mp3',
          body:
              "A small step for a man, but a giant leap to Flutter's community!",
          bigPicture: 'https://storage.googleapis.com/cms-storage-bucket/d406c736e7c4c57f5f61.png',
          largeIcon: 'https://storage.googleapis.com/cms-storage-bucket/0dbfcc7a59cd1cf16282.png',
      ...
      Future.delayed(
        ...
        () {
          AssetsAudioPlayer.newPlayer().open(
            Audio("assets/custom/sound/30Countdown.mp3"),

            notificationSettings: NotificationSettings(nextEnabled: false,
...
class _MyHomePageState extends State<MyHomePage> {
  TextEditingController _timeInSeconds = TextEditingController();
                            ...
                            MaterialButton(
                              onPressed: () {
                                NotificationController.scheduleNewNotification(
                                    seconds: int.parse(_timeInSeconds.text));
                              },
                              child: Text("Yes"),
                            )
                          ],
